  ...
  return (
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <div className="relative w-full h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-50 bg-gradient-to-t from-white via-black/20 to-transparent lg:bg-gradient-to-t  from-gray-300/50 via-black/20 to-transparent  z-10" />
      </div>

      {/* Bottom Section: Content Area */}
      {/* Usamos -mt-16 para o conteúdo começar dentro da área da névoa */}
      <div className="w-full flex-1 bg-white relative z-20 -mt-2 px-6 pb-8 flex flex-col items-center">
        {/* Logo and Brand Name */}
